...
class CoreCoverages:
    ...
    def start_coverages(self):
        ...
        self.browser.execute_script("document.getElementById('Wizard_Risks').click();")
        Actions.waitPageLoad(self.browser)
        Actions.check_for_value(self.browser, "Building.ConstructionCd", "Frame")
        Actions.check_for_value(self.browser, "Building.YearBuilt", keys=2020)
        Actions.check_for_value(self.browser, "Building.OccupancyCd","Owner occupied dwelling")
        Actions.check_for_value(self.browser, "Building.Seasonal", "No")
        Actions.check_for_value(self.browser, "Risk.TypeCd", self.dwelling_program)
        Actions.check_for_value(self.browser, "Building.BuildingLimit", keys=300000)
        Actions.check_for_value(self.browser, "Building.NumOfFamilies", "1")
        Actions.check_for_value(self.browser, "Building.OccupancyCd", "Primary Residence")
        Actions.check_for_value(self.browser, "Building.CovALimit",keys=self.coverage_a)
        Actions.check_for_value(self.browser, "Building.NumOfFamiliesSameFire", "Less Than 5", False, None)
        Actions.check_for_value(self.browser, "Building.FuelLiability", "300000")
        ...
        Actions.check_for_value(self.browser, "Building.CovCLimit",keys=self.coverage_c)
        ...
        Actions.check_for_value(self.browser, "Risk.WorkersCompEmployees", "none")
        Actions.check_for_value(self.browser, "Building.HurricaneMitigation", "No Action")
        Actions.check_for_value(self.browser, "Building.BuildingClassDescription", "75% or more Apartments")
        Actions.check_for_value(self.browser, "Building.BuildingClassDescription", "67% or more Apartments")
        Actions.check_for_value(self.browser, "Building.ContentClassDescription", "None - Building Owner only")
        Actions.check_for_value(self.browser, "Building.BuildingLimit", keys=900000)
        Actions.check_for_value(self.browser, "Building.OilTankLocation", "none")
        Actions.check_for_value(self.browser, "Building.DistanceToHydrant", "1000")
        Actions.check_for_value(self.browser, "Risk.SqFtArea", keys=2000)
        Actions.check_for_value(self.browser, "Risk.PremisesAlarm", "None", True)
        Actions.check_for_value(self.browser, "Risk.YrsInBusinessInd", "1", True)
        Actions.check_for_value(self.browser, "Building.NumOfApartmentCondoBuilding", keys=5)
        Actions.check_for_value(self.browser, "Building.MaxNumOfAptCondoBetweenBrickWalls", keys=5)
        ...
        try:
            ...
            MultiLog.add_log(f"Time to complete Core Coverages: {self.core_coverages_time.compute_time()} seconds", logging.INFO)
